        ...
        <div className="flex flex-col gap-10 lg:flex-row lg:items-center lg:gap-16">
          ...
          <Reveal delay={120} className="shrink-0">
            <img
              ...
              height={320}
              decoding="async"
              className="h-60 w-60 rounded-3xl border border-faint object-cover shadow-[0_16px_40px_-18px_rgba(26,32,41,0.35)] sm:h-72 sm:w-72 lg:h-80 lg:w-80"
            />
          </Reveal>
        </div>

        <Reveal delay={220} className="mt-10 flex flex-wrap items-center gap-x-8 gap-y-3">
          <EmailCopy />
